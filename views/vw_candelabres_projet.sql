DROP VIEW IF EXISTS export.vw_candelabres_projet;

CREATE OR REPLACE VIEW export.vw_candelabres_projet AS
...
WHERE obrv.idorc_obrv = 17 and obrv.idprj_obrv != 1 and ndfv.idprj_ndfv != 1; -- 17 candélabres