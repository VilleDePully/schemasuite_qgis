DROP VIEW IF EXISTS sigip.vw_coffrets_projet;

CREATE OR REPLACE VIEW sigip.vw_coffrets_projet AS
...
WHERE idorc_obrv IN (14,41,42) and id_prj != 1; --coffret, maison, immeuble
