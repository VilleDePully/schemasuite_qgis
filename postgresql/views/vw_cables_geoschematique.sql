DROP VIEW IF EXISTS export.vw_cables_geoschematique;

CREATE OR REPLACE VIEW export.vw_cables_geoschematique AS
...
WHERE obrv.idorc_obrv IN (4,18,19) 
	AND obrv.idprj_obrv = 1; -- cable générique, electrique
