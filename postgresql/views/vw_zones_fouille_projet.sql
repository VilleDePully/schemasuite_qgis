DROP VIEW IF EXISTS export.vw_zones_fouille_projet;

CREATE OR REPLACE VIEW export.vw_zones_fouille_projet AS
...
WHERE obrv.idorc_obrv = 3 
	AND obrv.idprj_obrv != 1; -- zones de fouilles
