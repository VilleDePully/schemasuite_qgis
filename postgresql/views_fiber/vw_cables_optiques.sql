...
FROM dbo.objetreseauversion_obrv obrv
	...
	LEFT JOIN dbo.projet_prj prj_parent ON prj_parent.id_prj = prj.idprj_prj
	LEFT JOIN export.vw_cable_et_fibre_optique_stats_geom cfo ON cfo.id_cableoptique = obrv.idobr_obrv
